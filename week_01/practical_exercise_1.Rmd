...
pacman::p_load(ggplot2, tidyverse, dplyr, boot)
```
...
Bhat <- model$coefficients;Bhat
Y <- mtcars[,1];Y
X <- mtcars[,6];X
error <- model$residuals;error
# I didn't get any further than this. I will try to do better next week.
